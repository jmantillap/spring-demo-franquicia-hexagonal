...
import work.javiermantilla.franquicia.infrastructure.in.rest.dto.SucursalRequestDTO;
import work.javiermantilla.franquicia.infrastructure.in.rest.dto.SucursalUpdateRequestDTO;
...
public class SucursalControllerAdapter {
	...
	public ResponseEntity<Object> crearSucursal(@Valid @RequestBody SucursalRequestDTO sucursalDTO) {
		...
		genericResponse = new GenericResponseDTO(
				this.sucursalUseCasePortIn.crearSucursal(GenericMapper.map(sucursalDTO,Sucursal.class)),
				true,
	...
	public ResponseEntity<Object> actualizarNombre(@Valid @PathVariable Integer id
		...
		genericResponse = new GenericResponseDTO(
				this.sucursalUseCasePortIn.updateSucursal(id,GenericMapper.map(sucursalUpdateDTO,Sucursal.class)), 
				true,
