...
import work.javiermantilla.franquicia.domain.ports.out.FranquiciaRepositoryPortOut;
...
public class FranquiciaServicesUsesCase implements FranquiciaUseCasePortIn {
	...
	@Override
	public Franquicia crearFranquicia(Franquicia franquiciaDTO) {
	...
	@Override
	public Franquicia updateFranquicia(Integer id, Franquicia dto) {
